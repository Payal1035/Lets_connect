...
var PieChart = /** @class */ (function (_super) {
	...
	PieChart.prototype.drawInfo = function () {
		var _this = this;
		return this.createHTMLElement("p", this.values.map(function (value, i) { return "<span style=\"color: " + _this.colors[i] + "\">&#9632;</span> " + _this.names[i] + ": " + value + " (" + _this.percents(value) + ")"; }).join("<br />"), {
			align: "center"
		});
	};
