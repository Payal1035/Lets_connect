...
const Twitter = () => {
  return (
    <div className="h-full  bg-[#05141C] py-10 px-5 text-white flex gap-5 overflow-hidden">
      {/* leftside */}
      ...
      <div className="w-1/4 overflow-hidden ">
        ...
        <div className="bg-[#1B2730] text-center rounded-lg  ">
          <div className="h-20 w-full bg-[#98C9B4] rounded-lg   "></div>
          <img
            className="z-1 rounded-full object-cover w-16 h-16 relative bottom-9 m-auto "
          ...
          <div className="flex justify-around my-3 border-y-2 border-gray-700 py-3 ">
            <div>
              <h1>6,664</h1>
              <p>Following</p>
            </div>
        ...
        <div className="bg-[#1B2730] p-6 rounded-lg ">
          ...
          <div className="flex gap-5 mb-5">
            ...
            <button className="text-black bg-white px-7 rounded-full font-bold">
              follow
            </button>
          </div>
      ...
      <div className="w-1/2 overflow-hidden">
        <div className="bg-[#1B2730] text-center rounded-lg p-4 mb-4">
          <div className="flex gap-3 items-center">
            <div className="cn">
              <img
                className=" rounded-full object-cover w-10 h-10 relative  "
                src="data:image/jpeg;base64,"
                alt=""
              />
            </div>
            <div className="w-full p-4">
              <input
                className="w-full h-full p-2 text-white bg-gray-700 rounded-xl"
                type="text"
          ...
          <div className="flex gap-3 justify-end px-3">
            <button className="flex bg-transparent rounded-full gap-1 py-1 px-7 items-center  border-2 border-gray-700">
        ...
        <div className="bg-[#1B2730]  rounded-lg p-4 mb-4">
          <div className="">
            <div className="flex gap-3  mb-4">
              ...
              />
              <div>
                <h1 className=" flex gap-3">Elon musk</h1>
                <p>Few minutes ago</p>
              </div>
            ...
            <div className="flex pl-16 gap-1 justify-between px-5 text-white">
        ...
        <div className="bg-[#1B2730]  rounded-lg p-4 mb-4">
          <div className="">
            ...
            <div className="flex justify-center w-full mb-7 pl-16 pr-5 rounded-lg ">
              <img
      ...
      {/* right starts */}
      <div className="w-1/4">
        <div className="bg-[#1B2730]  rounded-lg p-4  ">
          {/* first block */}
          <div className="border-b-2 border-gray-600 mb-5">
            ...
            <div className="mt-5 flex justify-between mb-3">
              <div className="cn">
                <h1>#Minions</h1> <p>97.8 k tweets </p>
              </div>
              <div className="cn">
                {" "}
                <BsThreeDots />{" "}
...
<div className=" mb-5">
            ...
            <h1 className="text-blue-400">Show More</h1>
          </div>
