                        ...
                        <div className='bg-white h-30 w-full rounded-lg flex p-2 mb-3'>
                            ...
                            <div className='m-2 w-[80%]'>
                                ...
                                <div className='flex w-full justify-start mt-3 gap-5'>
                                    <button className='bg-[#eff1f7]  px-3 py-1 rounded-lg text-blue-400 font-semibold'>Accept</button>
                                    <button className='bg-[#eff1f7]  px-3 py-1 rounded-lg text-red-400 font-semibold'>Decline</button>
                                </div>
                            </div>
                        </div>
                        <div className='bg-white h-30 w-full rounded-lg flex p-2 mb-3'>
