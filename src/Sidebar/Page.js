    ...
    return (
        <div className={'App ${colorTheme}'}>
            <div className='bg bg-black flex'>
                {/* Left side */}
                {/* <div className='pt-6'> */}
                <div className='w-[22%] rounded-xl p-4 bg-black text-white lg:static sticky'>
                    {/*Profile Section */}
                    <div className='lg:block hidden'>
                        <div className='flex border-2 p-2 pt-1 pl-4 rounded-2xl bg-gray-900 border-gray-900 bgc'>
                            <div>
                                <img
                    ...
                    {/*Menu Section*/}
                    <div className='border-2 mt-5 pt-5 rounded-2xl bg-gray-900 border-gray-900 pb-5 pl-0 pr-0'>
                        <a className=''>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0 font-bold p-2'>

                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-house-door text-slate-400 lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                        ...
                        <a>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0 font-bold p-2'>
                                ...
                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-compass text-slate-400 lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                                <div className='ml-2 lg:block hidden'>
                                    <h3>Explore</h3>
                                </div>
                        ...
                        <a>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0 font-bold p-2'>
                                ...
                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-bell text-slate-400 lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                                <div className='ml-2 lg:block hidden'>
                                    <h3>Notifications</h3>
                                </div>
                        ...
                        <a>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0 font-bold p-2'>
                                ...
                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-envelope text-slate-400 lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                                <div className='ml-2 lg:block hidden'>
                                    <h3>Messages</h3>
                                </div>
                        ...
                        <a>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0 font-bold p-2'>
                                ...
                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-bookmark text-slate-400 lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                                <div className='ml-2 lg:block hidden'>
                                    <h3>Bookmarks</h3>
                                </div>
                        ...
                        <a>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0 font-bold p-2'>
                                ...
                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-graph-up-arrow text-slate-400 lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                                <div className='ml-2 lg:block hidden'>
                                    <h3>Analytics</h3>
                                </div>
                        ...
                        <a>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0  p-2 font-bold border-l-4 text-red-400 border-red-400 bg-black pt-2'>
                                ...
                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-palette lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                                <div className='ml-2 lg:block hidden'>
                                    <h3>Theme</h3>
                                </div>
                                <div className="-mt-14">
                                    <button className='flex p-2 border-2 rounded-2xl opacity-70 active:opacity-100' id='Gray' onClick={() => handleClick('Gray')}>
                                        <div className='w-4 h-4 bg-gray-700'></div>
                                        <div className="p-2"> Gray</div>

                                    </button>
                                    <button className='flex p-2 border-2 rounded-2xl opacity-70 active:opacity-100' id='Green' onClick={() => handleClick('Green')}>
                                        <div className='w-4 h-4 bg-green-900'></div>
                                        <div className="p-2"> Green</div>

                                    </button>
                                    <button className='flex p-2 border-2 rounded-2xl opacity-70 active:opacity-100' id='Blue' onClick={() => handleClick('Blue')}>
                        ...
                        <a>
                            <div className='flex h-12 lg:pl-6  gap-4 lg:mt-0 font-bold p-2'>
                                ...
                                <div className='lg:mx-0 lg:ml-2 mx-auto '>
                                    <i className="bi bi-gear text-slate-400 lg:text-base text-2xl py-2 lg:py-0"></i>
                                </div>
                                <div className='ml-2 lg:block hidden'>
                                    <h3>Settings</h3>
                                </div>
                ...
                <div className="lg:w-1/2 overflow-hidden pt-4 text-white pr-4">
                    <div className="bg-gray-900 text-center rounded-[5rem] px-1 mb-2 h-12 bgc">
                        <div className="flex gap-2 items-center ml-2">
                            <div className="cn hidden md:block">
                                <img
                                    className=" rounded-full object-cover w-8 h-8 relative pt-0 -mt-1 "
                                    src="data:image/jpeg;base64,"
                                    alt=""
                                />
                            </div>
                            <div className="lg:w-4/5 p-4 pl-2 pt-2">
                                <input
                                    className="w-full h-full p-2 text-white bg-gray-900 rounded-xl"
                                    type="text"
                                    placeholder="What's on your mind, Dina?"
                                />
                            </div>
                            <div className='pr-2 pb-2'>
                                <button className='bg-red-400 md:w-28 px-4 rounded-2xl h-8 '>
                                    Post
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="bg-gray-900  rounded-2xl p-4 pt-2 mb-4 mt-4">
                        <div className="text-sm">
                            <div className="flex gap-1 mb-4 text-base">
                                ...
                                />
                                <div>
                                    <h1 className=" flex gap-3 ">Lana Rose</h1>
                            ...
                            <div>
                                ...
                                <div className="flex justify-center w-full mb-7 rounded-lg ">
                                    <img
                                ...
                                <div className="flex gap-1 justify-between px-1 mb-8 ">
